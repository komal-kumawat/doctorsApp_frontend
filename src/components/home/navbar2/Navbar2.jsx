  ...
  return (
    <div className='navbar2'>
      ...
      <div className='navbar22'>
        <div className='navbar221'><img className='navbar221img' src={email} alt=''></img>komal@gmail.com</div>
        <div className='navbar221'><img className='navbar222img' src={phone} alt=''></img>9987567942</div>
